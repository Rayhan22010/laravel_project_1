        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('hero_carousel_update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <input type="hidden" name="info_id" id="info_id">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="address" class="form-label">Carousel Heading</label>
                                <input type="text" value="" class="form-control" id="Carousel_heading"
                                    aria-describedby="emailHelp" name="Carousel_heading">
                                <div id="emailHelp" class="form-text"></div>
                            </div>
                            <div class="mb-3">
                                <label for="city" class="form-label">button Name</label>
                                <input type="text" value="" class="form-control" id="btn_name"
                                    aria-describedby="emailHelp" name="btn_name">
                            </div>
                        </div>
                ...
                <div class="offcanvas-lg offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item dropdown_item mb-1 active">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="container">
                    <div class="align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Hero carousel</h1>
                    </div>
                    <form action="{{ route('hero_carousel.store') }}" method="post" enctype="multipart/form-data"
                        class="row g-3">
                        @csrf
                        <div class="col-md-6">
                            <label for="C_image" class="form-label">Hero carousel image</label>
                            <input type="file" class="form-control" id="H_image" name="H_image" value="">
                        </div>
                        <div class="col-md-6">
                            <label for="C_title" class="form-label">Carousel heading</label>
                            <input type="text" class="form-control" id="Carousel_heading" name="Carousel_heading"
                                placeholder="Carousel_heading" value="">
                        </div>
                        <div class="col-md-6">
                            <label for="C_subtitle" class="form-label">Button name</label>
                            <input type="text" class="form-control" id="btn_name" name="btn_name"
                                placeholder="btn_name" value="" required>
                        </div>
                        ...
                        <table class="table table-striped table-sm">
                            ...
                            <tbody>
                                @foreach ($value as $data)
                                    <tr>
                                        <td>
                                            <img src="{{ asset('upload/studentImage/' . $data->H_image) }}"
                                                width="50px" height="50px">
                                        </td>
                                        <td>{{ $data->Carousel_heading }}</td>
                                        <td>{{ $data->btn_name }}</td>
                                        <td>
                                            <button value="{{ $data->id }}"
                                                class="btn btn-warning btn-sm editbtn">Edit</button>
                                            <a href="{{ route('hero_carousel.delete', $data->id) }}"
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.editbtn', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/hero_carousel_edit/" + info_id,
                    data: "data",
                    success: function(response) {
                        $('#Carousel_heading').val(response.data.Carousel_heading);
                        $('#btn_name').val(response.data.btn_name);
                        $('#info_id').val(info_id);
                    }
