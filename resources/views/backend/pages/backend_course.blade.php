        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('all_course_update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        <input type="hidden" name="info_id" id="info_id">
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="address" class="form-label">Course title</label>
                                <input type="text" value="" class="form-control" id="C_title"
                                    aria-describedby="emailHelp" name="C_title">
                                <div id="emailHelp" class="form-text"></div>
                            </div>
                            <div class="mb-3">
                                <label for="address" class="form-label">Course Sub-title</label>
                                <input type="text" value="" class="form-control" id="C_subtitle"
                                    aria-describedby="emailHelp" name="C_subtitle">
                                <div id="emailHelp" class="form-text"></div>
                            </div>
                            <div class="mb-3">
                                <label for="address" class="form-label">Course Price</label>
                                <input type="text" value="" class="form-control" id="C_price"
                                    aria-describedby="emailHelp" name="C_price">
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="container">
                    ...
                    <form action="{{ route('all_course.store') }}" method="post" enctype="multipart/form-data"
                        class="row g-3">
                        @csrf
                        <div class="col-md-6">
                            <label for="C_image" class="form-label">Course Image</label>
                            <input type="file" class="form-control" id="C_image" name="C_image" value=""
                                required>
                        </div>
                        <div class="col-md-6">
                            <label for="C_title" class="form-label">Course title</label>
                            <input type="text" class="form-control" id="C_title" name="C_title"
                                placeholder="Course title" value="" required>
                        </div>
                        <div class="col-md-6">
                            <label for="C_subtitle" class="form-label">Course Sub-title</label>
                            <input type="text" class="form-control" id="C_subtitle" name="C_subtitle"
                                placeholder="Course sub-title" value="" required>
                        </div>
                        <div class="col-md-6">
                            <label for="C_price" class="form-label">Course price</label>
                            <input type="text" class="form-control" id="C_price" name="C_price"
                                placeholder="Course price" value="" required>
                        </div>
                        <div class="col-md-6">
                            <label for="C_star" class="form-label">Star mark</label>
                            <input type="text" class="form-control" id="C_star" name="C_star">
                        </div>
                        <div class="col-12">
                        ...
                        <table class="table table-striped table-sm">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col">Course Sub-title</th>
                                    <th scope="col">Course price</th>
                                    <th scope="col">Star mark</th>
                            ...
                            <tbody>
                                @foreach ($value as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->C_title }}</td>
                                        <td>{{ $data->C_subtitle }}</td>
                                        <td>{{ $data->C_price }}</td>
                                        <td>{{ $data->C_star }}</td>
                                        <td>
                                            <button value="{{ $data->id }}"
                                                class="btn btn-warning btn-sm editbtn">Edit</button>
                                            <a href="{{ route('all_course.delete', $data->id) }}"
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.editbtn', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/all_course_edit/" + info_id,
                    data: "data",
                    success: function(response) {
                        $('#C_title').val(response.data.C_title);
                        $('#C_subtitle').val(response.data.C_subtitle);
                        $('#C_price').val(response.data.C_price);
                        $('#info_id').val(info_id);
                    }
