        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('academic_work_update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('post')
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="city" class="form-label">Description Name</label>
                                <textarea class="form-control" name="description" id="description" style="height: 100px"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="address" class="form-label">Button Name</label>
                                <input type="text" value="" class="form-control" id="btn_learn"
                                    aria-describedby="emailHelp" name="btn_learn">
                                <div id="emailHelp" class="form-text"></div>
                            </div>
                        </div>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="container">
                    <div class="align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Acedamic works</h1>
                    </div>
                    <form action="{{ route('academic_work.store') }}" method="post" enctype="multipart/form-data"
                        class="row g-3">
                        @csrf
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label for="C_title" class="form-label">Heading</label>
                            <input type="text" class="form-control" id="heading" name="heading"
                                placeholder="heading" value="">
                        </div>
                        <div class="col-md-6">
                            <label for="C_title" class="form-label">Description</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="btn_learn" name="btn_learn"
                                placeholder="btn_name" value="">
                        </div>
                        ...
                        <table class="table table-striped table-sm">
                            ...
                            <tbody>
                                @foreach ($value as $data)
                                    <tr>
                                        <td>
                                            <img src="{{ asset('upload/studentImage/' . $data->image) }}" width="30px"
                                                height="30px">
                                        </td>
                                        <td>{{ $data->heading }}</td>
                                        <td style="width: 15rem">{{ $data->description }}</td>
                                        <td>{{ $data->btn_learn }}</td>
                                        <td>
                                            <button value="{{ $data->id }}"
                                                class="btn btn-warning btn-sm editbtn">Edit</button>
                                            <a href="{{ route('academic_work.delete', $data->id) }}"
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.editbtn', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/academic_work_edit/" + info_id,
                    data: "data",
                    success: function(response) {
                        $('#heading').val(response.data.heading);
                        $('#description').val(response.data.description);
                        $('#btn_learn').val(response.data.btn_learn);
                        $('#info_id').val(info_id);
                    }
