        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('about_university_update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('post')
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="container">
                    <div class="align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">About University</h1>
                    </div>
                    <form action="{{ route('about_university.store') }}" method="post" enctype="multipart/form-data"
                        class="row g-3">
                        @csrf
                        <div class="col-md-6">
                                ...
                                @foreach ($value as $data)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('about_university.delete', $data->id) }}"
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.editbtn', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/about_university_edit/" + info_id,
                    data: "data",
