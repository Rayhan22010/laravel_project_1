        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('key_feature_update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('post')
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="container">
                    ...
                    <form action="{{ route('key_feature.store') }}" method="post" enctype="multipart/form-data"
                        class="row g-3">
                        @csrf
                        <div class="col-md-6">
                                ...
                                @foreach ($value as $data)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('key_feature.delete', $data->id) }}"
