            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('testimonial_update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="address" class="form-label">Clint Name</label>
                                <input type="text" value="" class="form-control" id="clintName"
                                    aria-describedby="emailHelp" name="clintName">
                                <div id="emailHelp" class="form-text"></div>
                            </div>
                            <div class="mb-3">
                                <label for="city" class="form-label">Work field </label>
                                <input type="text" value="" class="form-control" id="workField"
                                    aria-describedby="emailHelp" name="workField">
                            </div>
                            <div class="mb-3">
                                <label for="state" class="form-label">Review</label>
                                <textarea class="form-control" name="clintReview" id="clintReview" style="height: 100px"></textarea>
                            </div>
                        </div>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="container">
                    ...
                    <form action="{{ route('testimonial.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        @csrf
                        <div class="col-md-6">
                            <label for="validationDefault02" class="form-label">Clint name</label>
                            <input type="text" class="form-control" id="clintName" name="clintName" value=""
                                required>
                        </div>
                        <div class="col-md-6">
                            <label for="validationDefault02" class="form-label">work field</label>
                            <input type="text" class="form-control" id="workField" name="workField" value=""
                                required>
                        </div>
                        <div class="col-md-6">
                            <label for="validationDefault02" class="form-label">Clint picture</label>
                            <input type="file" class="form-control" id="clintPicture" name="clintPicture"
                                value="" required>
                        </div>
                        <div class="col-md-6">
                            <label for="validationDefault02" class="form-label">Review</label>
                            <textarea class="form-control" placeholder="Leave a comment here" name="clintReview" id="clintReview"
                            ...
                            <tbody>
                                @foreach ($value as $data)
                                    <tr>
                                        ...
                                        <td style="width: 15rem">{{ $data->clintReview }}</td>
                                        <td>
                                            <button value="{{ $data->id }}"
                                                class="btn btn-warning btn-sm editbtn">Edit</button>
                                            <a href="{{ route('testimonial.delete', $data->id) }}"
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.editbtn', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/testimonial_edit/" + info_id,
                    data: "data",
                    success: function(response) {
                        $('#clintName').val(response.data.clintName);
                        $('#workField').val(response.data.workField);
                        $('#clintReview').val(response.data.clintReview);
                        $('#info_id').val(info_id);
                    }
