                ...
                <div class="modal-body">
                    <form action="{{ url('course_update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="city" class="form-label">Course subtitle</label>
                                <input type="text" value="" class="form-control" id="C_subtitle"
                                    aria-describedby="emailHelp" name="C_subtitle">
                            </div>
                            <div class="mb-3">
                                <label for="state" class="form-label">Course price</label>
